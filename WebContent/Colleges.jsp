...
<jsp:useBean id="obj" class="vik.Colleges"/>
...
<div id="Layer1"  style="position:absolute; width:274px; height:63px; z-index:1; left: 9px; top: 273px;">
        <h1 class="style2">
          ...
          <img src="images/COLL.JPG" width="263" height="48">
          </marquee>
        </h1>
</div>
...
<div id="Layer1" style="position:absolute; width:645px; height:37px; z-index:1; left: 310px; top: 340px;">
  <div align="center">
    <%obj.linkcol();%>
     </div>
</div>								
